    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('home')); ?>#FeaturedMajors">Majors</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('home')); ?>#Departments">Departments</a>
                </li>
                    ...
                    <div class="dropdown">
                        <button class="btn btn-primary dropdown-toggle d-flex align-items-center"
                            ...
                            <div class="text-start">
                                <div class="small fw-bold">   <?php if(Auth::user()->isAdmin()): ?> Admin <?php else: ?> Student <?php endif; ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <?php if(Auth::user()->isStudent()): ?>
                                <li>
                                    <a class="dropdown-item <?php echo e(request()->routeIs('student.profile') ? 'active' : ''); ?>"
...
<?php /**PATH C:\laragon\www\jic_catalog\resources\views/layouts/app.blade.php ENDPATH**/ ?>