                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                        <div class="message-body">
                            <a href="<?php echo e(route('admin.profile')); ?>" class="d-flex align-items-center gap-2 dropdown-item">
...
<?php /**PATH C:\laragon\www\ubs\resources\views/admin/layouts/head.blade.php ENDPATH**/ ?>